...
namespace DbFirstMvc.Controllers
{
    public class CommentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Articleid,Text,Createdon,Author")] Comment comment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Articleid,Text,Createdon,Author")] Comment comment)
        {
            if (id != comment.Id)
            {
                return NotFound();
